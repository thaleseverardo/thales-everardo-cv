...
export const TRANSLATIONS = {
  PT: {
    ...
    'auth.modalTitle': 'Identificação de Segurança',
    'auth.modalSubtitle': 'Para proteger WhatsApp, telefone e e-mail contra robôs e scrapers automatizados, identifique-se para liberar o acesso direto.',
    'auth.continueWithGoogle': 'Continuar com Google',
    'auth.orEmail': 'ou com e-mail e senha',
    'auth.signIn': 'Entrar',
    'auth.signUp': 'Cadastrar',
    'auth.noAccount': 'Não tem conta? Cadastrar',
  ...
  EN: {
    ...
    'nav.verifiedSession': 'Verified Session',
    ...
    'auth.modalTitle': 'Security Verification',
    'auth.modalSubtitle': 'To protect WhatsApp, phone, and direct email from automated scrapers, verify your identity to unlock access.',
    'auth.continueWithGoogle': 'Continue with Google',
    'auth.orEmail': 'or with email and password',
    'auth.signIn': 'Sign In',
    'auth.signUp': 'Sign Up',
  ...
  ES: {
    ...
    'auth.modalTitle': 'Verificación de Seguridad',
    'auth.modalSubtitle': 'Para proteger WhatsApp, teléfono y correo contra scrapers automatizados, identifíquese para desbloquear el acceso directo.',
    'auth.continueWithGoogle': 'Continuar con Google',
    'auth.orEmail': 'o con correo y contraseña',
    'auth.signIn': 'Iniciar Sesión',
    'auth.signUp': 'Registrarse',
    'auth.noAccount': '¿No tienes cuenta? Registrarse',
  ...
  FR: {
    ...
    'auth.modalTitle': 'Vérification de Sécurité',
    'auth.modalSubtitle': "Pour protéger WhatsApp, téléphone et email direct contre les robots, authentifiez-vous pour débloquer l'accès.",
    'auth.continueWithGoogle': 'Continuer avec Google',
    'auth.orEmail': 'ou avec email et mot de passe',
