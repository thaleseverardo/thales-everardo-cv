...
export const TRANSLATIONS = {
  PT: {
    ...
    'footer.terminal': 'Terminal CLI (Ctrl+K)',
  },
  EN: {
    ...
    'nav.timelineView': 'Timeline',
    'nav.cvButton': 'Resume',
    'nav.contactButton': 'HANDSHAKE',
    'nav.preferences': 'PREFERENCES',
    'nav.language': 'Language',
    'nav.theme': 'Visual Theme',
    'nav.themeLight': 'Light',
    'nav.themeDark': 'Dark',
    'nav.audioFx': 'Audio FX',
    'nav.openCli': 'Open Shell CLI',
    ...
    'footer.terminal': 'CLI Terminal (Ctrl+K)',
  },
  ES: {
...
export function getNodeContent(node: ArchitectureNode, lang: AppLanguage): {
  ...
  if (transObj && 'shortTitle' in transObj) {
    // Assert para TypeScript garantir que estamos lendo as propriedades vitais
